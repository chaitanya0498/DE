...
/* Populate Your Dimension Table with values*/
	...
	INSERT INTO BPP_L2_dim_prova_chan_date
	SELECT
...
-- Good Friday  April 18 
	UPDATE BPP_L2_dim_prova_chan_date
...
/*Update HOLIDAY Field of USA In dimension*/
	...
	FROM BPP_L2_dim_prova_chan_date
	WHERE DateKey IN 
		(
		SELECT
			MAX(DateKey)
	...
	DateID int, Week TINYINT, YEAR CHAR(4), DAY CHAR(2))
		...
		FROM BPP_L2_dim_prova_chan_date DT
...
SELECT * FROM BPP_L2_dim_prova_chan_date
ALTER TABLE BPP_L2_dim_prova_chan_date ADD
...
FROM @tb a
	INNER JOIN BPP_L2_dim_prova_chan_date b ON a.PeriodDate = b.[Date]
